 ...
 *             Class given an item's category name with one entry for each
 *             level in the category hierarchy.
 *             &lt;/summary&gt;
 * </pre>
 * 
 * 
 * <p>Java class for CategoryIdListType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CategoryIdListType">
 *   &lt;complexContent>
...
@XmlType(name = "CategoryIdListType", propOrder = {
    "id"
})
public class CategoryIdListType {
