 ...
 *             Type containing name, address and phone information.
 *             &lt;/summary&gt;
 * </pre>
 * 
 * 
...
public class AddressType {
    ...
    @XmlElementRef(name = "Title", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> title;
    @XmlElementRef(name = "Name", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> name;
    @XmlElementRef(name = "Street1", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> street1;
    @XmlElementRef(name = "Street2", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> street2;
    @XmlElementRef(name = "City", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> city;
    @XmlElementRef(name = "Region", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> region;
    @XmlElementRef(name = "PostalCode", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    protected JAXBElement<String> postalCode;
    @XmlElementRef(name = "Country", namespace = "urn:shopster:apis:main", type = JAXBElement.class)
    ...
    public void setStreet1(JAXBElement<String> value) {
        this.street1 = ((JAXBElement<String> ) value);
    }
    ...
    public void setStreet2(JAXBElement<String> value) {
        this.street2 = ((JAXBElement<String> ) value);
    }
