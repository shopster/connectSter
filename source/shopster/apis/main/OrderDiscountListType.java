 ...
 *             Type containing a list of order discounts.
 *             &lt;/summary&gt;
 * </pre>
 * 
 * 
 * <p>Java class for OrderDiscountListType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OrderDiscountListType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Discount" type="{urn:shopster:apis:main}OrderDiscountType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OrderDiscountListType", propOrder = {
    "discount"
})
public class OrderDiscountListType {

    @XmlElement(name = "Discount", nillable = true)
    protected List<OrderDiscountType> discount;
     ...
     * {@link OrderDiscountType }
     * 
     * 
     */
    public List<OrderDiscountType> getDiscount() {
        if (discount == null) {
            discount = new ArrayList<OrderDiscountType>();
        }
