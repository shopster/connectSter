...
implements IMasterProxy
{
    ...
    @Override
    public IResponse<IProductMapping> proxyGetProductMapping( AdapterConnection slaveAdapter, long productId )
    {
        return EntityHelper.execute( new GetMappedProductCommand( ), EntityHelper.listToMap( ICommand.PARAMETER_ADAPTER_ID,
            slaveAdapter.getInstalledAdapter( ).getDetails( ).getId( ), ICommand.PARAMETER_PRODUCT_ID, productId ) );
    }
    ...
    {
        return EntityHelper.execute( new AddOrderCommand( ), EntityHelper.listToMap( ICommand.PARAMETER_ORDER,
            order ) );
    }
    ...
    @Override
    public IResponse<IProductMapping> getProductMapping( long productId )
    {
        return EntityHelper.execute( new GetMappedProductCommand( ), EntityHelper.listToMap( ICommand.PARAMETER_ADAPTER_ID,
            adapter.getId( ), ICommand.PARAMETER_PRODUCT_ID, productId ) );
    }
