...
import com.shopify.entity.*;
import com.shopify.exception.ShopifyRestException;
import com.shopster.ShopsterAdapter;
...
implements IAdapter
{
    ...
    public static final String METHOD_UPDATE_VARIANT = "/admin/products/#{id}/variants.xml";
    ...
    public void addOrder( ShopifyOrder shopifyOrder, long userId )
    {
        ...
        order.setBillingRegion( billingAddress.getProvince( ) );
        order.setBillingStreet1( billingAddress.getAddress1( ) );
        order.setBillingStreet2( billingAddress.getAddress2( ) );
        ...
        order.setShippingRegion( shippingAddress.getProvince( ) );
        order.setShippingStreet1( shippingAddress.getAddress1( ) );
        order.setShippingStreet2( shippingAddress.getAddress2( ) );

        // here we walk over all line items and try to locate their connectster counterpart, if any are not found then error this order out
